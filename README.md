...
- If you move the executable without moving the files it creates when it's run, it will simply create new files in the new directory.
- Running the executable in OneDrive provides a better experience across your devices. Simply, put the executable in OneDrive, then create a shortcut for easy access.
